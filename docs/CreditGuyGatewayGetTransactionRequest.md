...
**credentials** | [**AllOfCreditGuyGatewayGetTransactionRequestCredentials**](AllOfCreditGuyGatewayGetTransactionRequestCredentials.md) | Company API public credentials | 
