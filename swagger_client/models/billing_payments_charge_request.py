...
class BillingPaymentsChargeRequest(object):
    ...
    swagger_types = {
        ...
        'update_customer_by_email_language': 'str',
        'send_document_by_email': 'bool',
        'send_document_by_email_language': 'str',
    ...
    def update_customer_by_email_language(self, update_customer_by_email_language):
        ...
        if update_customer_by_email_language not in allowed_values:
            raise ValueError(
                "Invalid value for `update_customer_by_email_language` ({0}), must be one of {1}"  # noqa: E501
                .format(update_customer_by_email_language, allowed_values)
            )
    ...
    def send_document_by_email_language(self, send_document_by_email_language):
        ...
        """
        allowed_values = ["Hebrew", "English", "Arabic", "Spanish"]  # noqa: E501
        if send_document_by_email_language not in allowed_values:
            raise ValueError(
                "Invalid value for `send_document_by_email_language` ({0}), must be one of {1}"  # noqa: E501
                .format(send_document_by_email_language, allowed_values)
            )
    ...
    def document_language(self, document_language):
        ...
        """
        allowed_values = ["Hebrew", "English", "Arabic", "Spanish"]  # noqa: E501
        if document_language not in allowed_values:
            raise ValueError(
                "Invalid value for `document_language` ({0}), must be one of {1}"  # noqa: E501
                .format(document_language, allowed_values)
            )
