...
class AccountingGeneralUpdateSettingsRequest(object):
    ...
    def __init__(self, documents_email_address_specified=None, documents_email_address=None, accountant_email_specified=None, accountant_email=None, income_tax_credit_for_donation=None, enable_custom_document_dates=None, credentials=None):  # noqa: E501
