...
------------ | ------------- | ------------- | -------------
**item** | [**BillingTypedRecurringItem**](BillingTypedRecurringItem.md) | Item | 
...
**currency** | **str** | Price currency&lt;div&gt;&lt;i&gt;Leave empty for company currency or when using UseItemDetails&lt;/i&gt;&lt;/div&gt; | [optional] 
...
**recurrence** | **int** | Number of recurring payments&lt;div&gt;&lt;i&gt;For instance, for 1 year of monthly payments, specify 12.  Setting this to 0 will result in continuous payments&lt;/i&gt;&lt;/div&gt; | [optional] 
