...
------------ | ------------- | ------------- | -------------
**details** | [**AllOfAccountingDocumentsCreateRequestDetails**](AllOfAccountingDocumentsCreateRequestDetails.md) | General document details | 
...
**credentials** | [**AllOfAccountingDocumentsCreateRequestCredentials**](AllOfAccountingDocumentsCreateRequestCredentials.md) | Company API credentials | 
