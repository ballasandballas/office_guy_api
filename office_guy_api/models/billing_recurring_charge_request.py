...
class BillingRecurringChargeRequest(object):
    ...
    def __init__(self, customer=None, payment_method=None, single_use_token=None, items=None, update_customer_by_email=None, update_customer_by_email_attach_document=None, authorise_only=None, document_type=None, send_copy_to_organization=None, vat_included=None, attribution_offset=None, credit_card_payments_count=None, credentials=None):  # noqa: E501
