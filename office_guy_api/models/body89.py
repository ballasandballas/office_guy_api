...
class Body89(object):
    ...
    def __init__(self, get_format_preserving=None, card_number=None, force_format_preserving_token=None, credentials=None, *args, **kwargs):  # noqa: E501
        """Body89 - a model defined in Swagger"""  # noqa: E501
    ...
    def get_format_preserving(self, get_format_preserving):
        """Sets the get_format_preserving of this Body89.

        Should tokenize method also return format preserved token, or only Guid token<div><i>Defaults to False</i></div>  # noqa: E501

        :param get_format_preserving: The get_format_preserving of this Body89.  # noqa: E501
        :type: bool
        """
    ...
    def card_number(self):
        """Gets the card_number of this Body89.  # noqa: E501

        Full card number to tokenize  # noqa: E501

        :return: The card_number of this Body89.  # noqa: E501
        :rtype: str
        """
    ...
    def card_number(self, card_number):
        """Sets the card_number of this Body89.

        Full card number to tokenize  # noqa: E501

        :param card_number: The card_number of this Body89.  # noqa: E501
        :type: str
        """
    ...
    def force_format_preserving_token(self):
        """Gets the force_format_preserving_token of this Body89.  # noqa: E501
        ...
        :return: The force_format_preserving_token of this Body89.  # noqa: E501
        :rtype: str
        """
    ...
    def force_format_preserving_token(self, force_format_preserving_token):
        """Sets the force_format_preserving_token of this Body89.

        Forced format preserving token  This can be useful when migrating from another credit card gateway to OfficeGuy.  Please note the format preserving token should be a RANDOM identifier, which can't be reverse engineered into the card number (encoding/encrypting etc. isn't supported).  # noqa: E501

        :param force_format_preserving_token: The force_format_preserving_token of this Body89.  # noqa: E501
        :type: str
        """
    ...
    def credentials(self):
        """Gets the credentials of this Body89.  # noqa: E501

        Company API credentials  # noqa: E501

        :return: The credentials of this Body89.  # noqa: E501
        :rtype: Object
        """
    ...
    def credentials(self, credentials):
        """Sets the credentials of this Body89.

        Company API credentials  # noqa: E501

        :param credentials: The credentials of this Body89.  # noqa: E501
        :type: Object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Body89):
            return False
