...
class WebsiteCompaniesApi(object):
    ...
    def website_companies_get_details(self, **kwargs):  # noqa: E501
        """website_companies_get_details  # noqa: E501
    ...
    def website_companies_list_quotas(self, **kwargs):  # noqa: E501
        """website_companies_list_quotas  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.website_companies_list_quotas(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Body273 body:
        :param ContentLanguage content_language: Sets the content response language. Defaults to Hebrew (he).
        :return: ResponseWebsiteCompaniesListQuotasResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.website_companies_list_quotas_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.website_companies_list_quotas_with_http_info(**kwargs)  # noqa: E501
            return data

    def website_companies_list_quotas_with_http_info(self, **kwargs):  # noqa: E501
        """website_companies_list_quotas  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.website_companies_list_quotas_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method website_companies_list_quotas" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/website/companies/listquotas/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ResponseWebsiteCompaniesListQuotasResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
